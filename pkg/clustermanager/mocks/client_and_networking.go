...
// Source: github.com/aws/eks-anywhere/pkg/clustermanager (interfaces: ClusterClient,Networking,AwsIamAuth,AwsEcrCred)
...
// MockAwsEcrCred is a mock of AwsEcrCred interface.
type MockAwsEcrCred struct {
	ctrl     *gomock.Controller
	recorder *MockAwsEcrCredMockRecorder
}

// MockAwsEcrCredMockRecorder is the mock recorder for MockAwsEcrCred.
type MockAwsEcrCredMockRecorder struct {
	mock *MockAwsEcrCred
}

// NewMockAwsEcrCred creates a new mock instance.
func NewMockAwsEcrCred(ctrl *gomock.Controller) *MockAwsEcrCred {
	mock := &MockAwsEcrCred{ctrl: ctrl}
	mock.recorder = &MockAwsEcrCredMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockAwsEcrCred) EXPECT() *MockAwsEcrCredMockRecorder {
	return m.recorder
}

// GenerateAwsConfig mocks base method.
func (m *MockAwsEcrCred) GenerateAwsConfig() ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateAwsConfig")
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GenerateAwsConfig indicates an expected call of GenerateAwsConfig.
func (mr *MockAwsEcrCredMockRecorder) GenerateAwsConfig() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateAwsConfig", reflect.TypeOf((*MockAwsEcrCred)(nil).GenerateAwsConfig))
}
