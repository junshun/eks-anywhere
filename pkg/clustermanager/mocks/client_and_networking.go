...
// Source: github.com/aws/eks-anywhere/pkg/clustermanager (interfaces: ClusterClient,Networking,AwsIamAuth,AwsCred)
...
// MockAwsCred is a mock of AwsCred interface.
type MockAwsCred struct {
	ctrl     *gomock.Controller
	recorder *MockAwsCredMockRecorder
}

// MockAwsCredMockRecorder is the mock recorder for MockAwsCred.
type MockAwsCredMockRecorder struct {
	mock *MockAwsCred
}

// NewMockAwsCred creates a new mock instance.
func NewMockAwsCred(ctrl *gomock.Controller) *MockAwsCred {
	mock := &MockAwsCred{ctrl: ctrl}
	mock.recorder = &MockAwsCredMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockAwsCred) EXPECT() *MockAwsCredMockRecorder {
	return m.recorder
}

// GenerateAwsConfigPackages mocks base method.
func (m *MockAwsCred) GenerateAwsConfigPackages() ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateAwsConfigPackages")
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GenerateAwsConfigPackages indicates an expected call of GenerateAwsConfigPackages.
func (mr *MockAwsCredMockRecorder) GenerateAwsConfigPackages() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateAwsConfigPackages", reflect.TypeOf((*MockAwsCred)(nil).GenerateAwsConfigPackages))
}

// GenerateCredProviderConfig mocks base method.
func (m *MockAwsCred) GenerateCredProviderConfig() ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateCredProviderConfig")
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GenerateCredProviderConfig indicates an expected call of GenerateCredProviderConfig.
func (mr *MockAwsCredMockRecorder) GenerateCredProviderConfig() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateCredProviderConfig", reflect.TypeOf((*MockAwsCred)(nil).GenerateCredProviderConfig))
}
